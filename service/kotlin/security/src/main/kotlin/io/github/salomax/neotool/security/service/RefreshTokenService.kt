...
class RefreshTokenService(
    ...
    fun refreshAccessToken(refreshToken: String): TokenPair {
        ...
        if (tokenRecord.replacedBy != null) {
            logger.warn { "Refresh token reuse detected for user ${tokenRecord.userId} - revoking token family ${tokenRecord.familyId}" }
        ...
        val principal =
            principalRepository.findByPrincipalTypeAndExternalId(
                io.github.salomax.neotool.security.service.PrincipalType.USER,
