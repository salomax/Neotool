package io.github.salomax.neotool.security.service.auth
...
open class AuthenticationService(
     ...
     * @return JWT access token string
     */
    fun generateAccessToken(authContext: AuthContext): String = jwtTokenIssuer.generateAccessToken(authContext)
     ...
     */
    @Deprecated(
        "Use RefreshTokenService.refreshAccessToken() for token rotation support",
    ...
    fun generateRememberMeToken(): String = UUID.randomUUID().toString() + "-" + System.currentTimeMillis()
