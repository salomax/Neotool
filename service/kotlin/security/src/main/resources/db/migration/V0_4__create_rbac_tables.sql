...
-- Create role_assignments table for scoped role assignments with temporal validity
...
-- Add index on user_id, scope_type, and scope_id for scoped permission checks
