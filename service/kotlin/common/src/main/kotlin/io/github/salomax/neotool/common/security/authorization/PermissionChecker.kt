 ...
 *
 * This is the primary implementation of [AuthorizationChecker] for standard permission checks.
 * It validates permissions from JWT token claims, providing stateless, performant authorization.
 *
...
class PermissionChecker : AuthorizationChecker {
    ...
    override fun require(
        ...
        val permissions =
            when {
                principal.principalType == PrincipalType.SERVICE && principal.userId != null &&
                    principal.userPermissions != null -> {
