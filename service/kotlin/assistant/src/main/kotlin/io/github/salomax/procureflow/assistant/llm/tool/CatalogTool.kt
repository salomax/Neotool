...
class CatalogTool(
    ...
    fun getSearchFunction(): FunctionDefinition {
        return FunctionDefinition(
            ...
            description =
                "Search for catalog items by name or query string. " +
                    "Use this when the user wants to find items in the catalog.",
            parameters =
                FunctionParameters(
                    properties =
                        mapOf(
        ...
        return FunctionDefinition(
            ...
            description =
                "Get detailed information about a specific catalog item by its ID. " +
                    "Use this when the user asks about a specific item's details, price, status, or description.",
            parameters =
                FunctionParameters(
                    properties =
                        mapOf(
    ...
    fun getSaveFunction(): FunctionDefinition {
        return FunctionDefinition(
            ...
            description =
                "Save or enroll a new catalog item. " +
                    "Use this when the user wants to add a new item to the catalog.",
            parameters =
                FunctionParameters(
                    properties =
                        mapOf(
            ...
            try {
                when (functionName) {
                    ...
                    "saveCatalogItem" -> {
                        ...
                        val priceCents =
                            (arguments["priceCents"] as? Number)?.toInt()
