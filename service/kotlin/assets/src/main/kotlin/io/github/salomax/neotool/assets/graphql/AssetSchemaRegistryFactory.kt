...
class AssetSchemaRegistryFactory : BaseSchemaRegistryFactory() {
    ...
    override fun loadBaseSchema(): TypeDefinitionRegistry = loadSchemaFromResource("graphql/base-schema.graphqls")

    override fun loadModuleSchemas(): List<TypeDefinitionRegistry> = listOf(
