...
object TestDataBuilders {
    ...
    fun productsQuery(): Map<String, Any> =
        graphQLQuery(
            """
            query {
                products {
    ...
    fun customersQuery(): Map<String, Any> =
        graphQLQuery(
            """
            query {
                customers {
    ...
    fun deleteCustomerMutation(id: String): Map<String, Any> =
        graphQLQuery(
            """
            mutation {
    ...
    fun deleteProductMutation(id: String): Map<String, Any> =
        graphQLQuery(
            """
            mutation {
                deleteProduct(id: "$id")
    ...
    fun customerQuery(id: UUID): Map<String, Any> =
        graphQLQuery(
            """
            query {
                customer(id: "$id") {
    ...
    fun productQuery(id: UUID): Map<String, Any> =
        graphQLQuery(
            """
            query {
                product(id: "$id") {
