...
2. **Patterns**: Implementation patterns from `docs/05-backend/patterns/`
3. **Standards**: Coding standards from `docs/05-backend/standards/`
4. **Architecture**: Architecture decisions from `docs/92-adr/`
...
3. **Pattern Compliance**:
   - [ ] Follows appropriate pattern from `docs/05-backend/patterns/`
