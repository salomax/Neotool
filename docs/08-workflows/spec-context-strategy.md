...
- `docs/01-overview/architecture-overview.md` - System understanding
- `docs/04-domain/glossary.md` - Terminology
...
- `docs/05-backend/patterns/domain-model-pattern.md`

#### Backend Add-ons (Load Per Sub-Phase)

**Domain add-on** (schema/migrations/IDs):
- `docs/04-domain/database-schema-standards.md`
- `docs/05-backend/patterns/uuid-v7-pattern.md`
...
- `docs/05-backend/patterns/domain-entity-conversion.md`
...
- `docs/05-backend/patterns/mapper-pattern.md`
- `docs/06-contracts/graphql-query-pattern.md`
- `docs/06-contracts/graphql-standards.md`

**Pagination add-on** (lists/Relay connections):
- `docs/05-backend/patterns/pagination-pattern.md`

#### Frontend Base (Load Once for Frontend Work)
**Load**:
- `docs/92-adr/0004-typescript-nextjs-frontend.md`
- `docs/07-frontend/patterns/styling-pattern.md`
- `docs/07-frontend/patterns/shared-components-pattern.md`
- `docs/07-frontend/patterns/management-pattern.md`

#### Frontend Add-ons (Load When Needed)

**GraphQL add-on** (operations, cache updates, mutations):
- `docs/07-frontend/patterns/graphql-query-pattern.md`
- `docs/07-frontend/patterns/graphql-mutation-pattern.md`
- `docs/07-frontend/patterns/mutation-pattern.md`

**UX add-ons** (navigation/feedback):
- `docs/07-frontend/patterns/toast-notification-pattern.md`
- `docs/07-frontend/patterns/breadcrumb-pattern.md`

#### Testing Base + Add-ons
**Load**:
- `docs/05-backend/kotlin/testing-standards.md`
- `docs/05-backend/patterns/testing-pattern.md` (if backend)
...
- **Observability work**: `docs/10-observability/observability-overview.md`
...
**Load on Demand**:
- `docs/05-backend/kotlin/linting-standards.md` - During linting
- `docs/09-security/authentication.md` - For auth features
- `docs/10-observability/observability-overview.md` - For observability setup
...
**Example**:
- ✅ Load: `docs/05-backend/patterns/resolver-pattern.md`
- ❌ Don't load: `docs/90-examples/backend/crud-example/` (reference path only)
...
**Example**:
- ✅ Load: `docs/05-backend/patterns/resolver-pattern.md`
- ❌ Avoid: `docs/90-examples/backend/crud-example/` (reference path only)
- ✅ Reference: "See `docs/90-examples/backend/crud-example/` for complete example"
