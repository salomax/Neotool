...
- `docs/01-overview/architecture-overview.md` - System architecture
...
- **Patterns**: `docs/05-backend/patterns/`
- **Standards**: `docs/05-backend/standards/`
- **Templates**: `docs/91-templates/`
- **Validation**: `docs/94-validation/`
