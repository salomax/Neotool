...
2. **Code Style and Linting (CRITICAL - Apply During Implementation)**:
   - **MUST reference**: `docs/05-standards/coding-standards/linting-standards.md` for all lint rules
   ...
   - **Quick Reference**: See `docs/10-reference/linting-quick-reference.md` for common patterns
