...
[Paste feature file content from docs/03-features/[category]/[feature-name].feature]

## Specification References

- Architecture: spec/00-overview/architecture.md
- Project Structure: spec/00-overview/project-structure.md
...
3. Exact file paths for all artifacts:
   ...
   - Follow directory structure from spec/00-overview/project-structure.md
