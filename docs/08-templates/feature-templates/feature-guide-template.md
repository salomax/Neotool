...
- **Patterns**: Links to relevant patterns (`docs/04-patterns/`)
- **Standards**: Links to relevant standards (`docs/05-standards/`)
- **ADRs**: Links to relevant architecture decision records (`docs/09-adr/`)
- **Architecture**: Links to architecture documentation (`docs/00-overview/`, `docs/01-architecture/`)
