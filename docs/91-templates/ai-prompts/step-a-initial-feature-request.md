...
2. Generate a feature file in Gherkin format (docs/03-features/[category]/[feature-name].feature) following the pattern from docs/03-features/authentication/signin.feature
