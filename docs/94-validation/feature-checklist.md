...
- [ ] GraphQL schema follows federation rules (see `docs/06-contracts/graphql-standards.md`)
- [ ] Entity follows JPA patterns (see `docs/05-backend/patterns/entity-pattern.md`)
- [ ] Entity includes schema in `@Table` annotation (see `docs/04-domain/database-schema-standards.md`)
- [ ] Service follows clean architecture
- [ ] Repository extends appropriate base class
- [ ] Resolver follows resolver patterns (see `docs/05-backend/patterns/resolver-pattern.md`)
- [ ] Database migration created and tested
- [ ] Schema synced to contracts (`./neotool graphql sync`)
- [ ] Unit tests written (see `docs/05-backend/kotlin/testing-standards.md`)
