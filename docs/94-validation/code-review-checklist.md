...
- [ ] Schema follows federation rules (see `docs/06-contracts/graphql-standards.md`)
...
- [ ] Resolver follows resolver patterns (see `docs/05-backend/patterns/`)
...
- [ ] **Entity with UUID primary key uses UUID v7 pattern** (see `docs/05-backend/patterns/uuid-v7-pattern.md`)
...
- [ ] Domain-entity conversion handles nullable IDs correctly (see `docs/05-backend/patterns/domain-entity-conversion.md`)
...
- [ ] Components follow structure (see `docs/07-frontend/patterns/shared-components-pattern.md`)
...
- [ ] Components are in correct directory structure (see `docs/01-overview/project-structure.md`)

### GraphQL Operations

- [ ] GraphQL operations follow patterns (see `docs/07-frontend/patterns/graphql-query-pattern.md` and `docs/07-frontend/patterns/graphql-mutation-pattern.md`)
...
- [ ] Follows styling patterns (see `docs/07-frontend/patterns/styling-pattern.md`)
...
- [ ] Security standards followed (see `docs/05-backend/standards/security-standards/`)
