...
- **See**: [Database Standards](../05-standards/database-standards/schema-standards.md)
...
See [Security Standards](../05-standards/security-standards/authentication-standards.md) for detailed security patterns.
...
- [API Standards](../05-standards/api-standards/graphql-standards.md)
- [Security Standards](../05-standards/security-standards/authentication-standards.md)
...
4. Check [Standards](../05-standards/)
