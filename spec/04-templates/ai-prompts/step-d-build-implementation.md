...
5. Include comprehensive tests (REQUIRED):
   - Unit tests for all business logic (spec/01-rules/testing-rules.md)
   ...
   - Integration tests for API endpoints (spec/01-rules/testing-rules.md)
...
6. Follow all rules from spec/01-rules/:
   - Coding standards
   - Architecture rules
   - API rules
   - Database rules
...
7. Include observability (REQUIRED - spec/01-rules/observability-rules.md):
