...
[Paste feature file from docs/features/[category]/[feature-name].feature]
...
2. Validate against all rules (spec/01-rules/):
   - Coding Standards: spec/01-rules/coding-standards.md
   - Architecture Rules: spec/01-rules/architecture-rules.md
   ...
   - Security Rules: spec/01-rules/security-rules.md

3. Validate against patterns (spec/03-patterns/):
