...
ai_optimized: true
search_keywords: [architecture, overview, system-design, layers, patterns]
related:
  - 00-core/technology-stack.md
  - 00-core/project-structure.md
  - 00-core/principles.md
  - 08-adr/0001-monorepo.md
  - 08-adr/0002-containers.md
  - 08-adr/0003-kotlin-backend.md
  - 08-adr/0004-typescript-frontend.md
  - 08-adr/0005-postgresql.md
...
- **See**: [GraphQL Federation Pattern](../03-patterns/shared/graphql-federation.md)
- **ADR**: [ADR-0003: Kotlin Backend](../08-adr/0003-kotlin-backend.md)

### 2. Domain-Driven Design
- **Pattern**: Domain entities, services, repositories
- **Benefit**: Clear boundaries, testable code
- **See**: [Database Rules](../01-rules/database-rules.md)
- **Pattern**: [Repository Pattern](../03-patterns/backend/repository-pattern.md)

### 3. Clean Architecture
- **Pattern**: Layered architecture (API → Service → Repository → Entity)
- **Benefit**: Separation of concerns, testability
- **See**: [Architecture Rules](../01-rules/architecture-rules.md)
- **ADR**: [ADR-0003: Kotlin Backend](../08-adr/0003-kotlin-backend.md)

### 4. Component-Driven Development
- **Pattern**: Atomic design system (atoms, molecules, organisms)
- **Benefit**: Reusable UI components, design consistency
- **See**: [Component Pattern](../03-patterns/frontend/component-pattern.md)
- **ADR**: [ADR-0004: TypeScript Frontend](../08-adr/0004-typescript-frontend.md)
...
See [Security Rules](../01-rules/security-rules.md) for detailed security patterns.
...
- [ADR-0001: Monorepo Architecture](../08-adr/0001-monorepo.md)
- [ADR-0002: Containerized Architecture](../08-adr/0002-containers.md)
- [ADR-0003: Kotlin/Micronaut Backend](../08-adr/0003-kotlin-backend.md)
- [ADR-0004: TypeScript/Next.js Frontend](../08-adr/0004-typescript-frontend.md)
- [ADR-0005: PostgreSQL Database](../08-adr/0005-postgresql.md)

### Patterns
- [GraphQL Federation](../03-patterns/shared/graphql-federation.md)
- [Backend Patterns](../03-patterns/backend/)
- [Frontend Patterns](../03-patterns/frontend/)

### Rules
- [Architecture Rules](../01-rules/architecture-rules.md)
- [API Rules](../01-rules/api-rules.md)
- [Security Rules](../01-rules/security-rules.md)
...
2. Review [Architecture Decision Records](../08-adr/)
3. Explore [Patterns](../03-patterns/)
4. Check [Rules](../01-rules/)
