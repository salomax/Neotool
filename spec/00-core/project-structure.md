...
related:
  ...
  - 09-reference/file-structure.md
---
...
See [ADR-0001: Monorepo Architecture](../08-adr/0001-monorepo.md) for the decision rationale.
...
- [File Structure Reference](../09-reference/file-structure.md)
