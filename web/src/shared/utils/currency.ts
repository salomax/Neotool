...
/**
 * Parses a numeric value into its component parts (number, totalizer)
 * Similar to parseCurrencyValue but without currency symbol
 *
 * @param value - The numeric value to format
 * @param locale - Locale string (default: "pt-BR")
 * @param labels - Object with labels for short/long formats
 * @param totalizerFormat - Format for totalizer: "short" (bi/mi) or "long" (bilhões/milhões)
 * @returns Parsed number parts
 */
